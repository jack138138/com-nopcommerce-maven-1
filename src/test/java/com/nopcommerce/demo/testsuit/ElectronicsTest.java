...
public class ElectronicsTest extends BaseTest
{
    ...
    ElectronicCellPhonePage electronicCellPhonePage =new ElectronicCellPhonePage();
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException
    {
        ...
        electronicCellPhonePage.changeQTYToTwo();
        Thread.sleep(1000);
        ...
        electronicCellPhonePage.verifyTextProductAdded();
        Thread.sleep(1000);
        ...
        //shoppingCartPage.verifyQtyText();
        Thread.sleep(1000);

        //2.14 Verify the Total $698.00
        shoppingCartPage.verifyTotalCellPhoneText();
        Thread.sleep(1000);
        ...
        registrationPage.verifyRegisterText();
        Thread.sleep(1000);

        //2.20 Fill the mandatory fields
        registrationPage.fillAllRegisterField();
        Thread.sleep(1000);

...
public class RegistrationPage extends Utility
{
    ...
    public void fillAllRegisterField()
    {
        ...
        sendTextToElement(lastName,"peter");

        sendTextToElement(email,"jacksparrow@gmail.com");

        sendTextToElement(password,"jack123497978");

        sendTextToElement(confirmPassword,"jack123497978");
    }
